...
public class Book extends BaseAggregateRoot implements INamed, IRentable {
    ...
    private Money cost = Money.of(CurrencyUnit.USD,0);
...
//    @NotNull
    ...
    private Integer totalForSudarshanCopies;

    public Integer getTotalForSudarshanCopies() {
        return totalForSudarshanCopies;
    }

    public void setTotalForSudarshanCopies(Integer totalForSudarshanCopies) {
        this.totalForSudarshanCopies = totalForSudarshanCopies;
        System.out.println("TotalForSudarshanCopies --->  " + totalForSudarshanCopies);
